...
plt.title("Andamento dell'Accuratezza per ciascun LLM", fontsize=16)
plt.ylabel("Accuratezza")
plt.xlabel("Risposta")
plt.legend(title="LLM")
plt.xticks(range(1, 11))  # Assumendo che ci siano 10 risposte
plt.tight_layout()

# Salva o mostra il grafico
plt.savefig("andamento_accuratezza_llm.png")
plt.show()